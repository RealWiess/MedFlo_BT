...
#define CONFIG_UART_4_IRQ_PRI   0
#define CONFIG_UART_4_SPEED     3000000
#define CONFIG_UART_4_USE_TX_DMA   0
#define CONFIG_UART_4_TX_DMA_CHAN  0x0
#define CONFIG_UART_4_TX_DMA_ID    1
...
/* PMU SARADC config */
#define CONFIG_SARADC_NAME "SARADC"
#define CONFIG_SARADC_IRQ_PRI 0
...
#define CONFIG_PWM_TAI_FULL_FUNC 1

/* keypad config */
#define CONFIG_KEYPAD           0
#define CONFIG_KEYPAD_REG       1
...
/* quadrature decoder */
#define CONFIG_QD                1
#define CONFIG_QD_NAME           "qd"

#define CONFIG_QD_CYCLE          4000
#define CONFIG_QD_DT             3
#define CONFIG_QD_POLL_INTV      10
#define CONFIG_QD_MODE			{QDX_MODE_X1, QDY_MODE_X1, QDZ_MODE_X1}
...
#define CONFIG_AUTO_STANDBY_TIME_MSEC 1000//5000 //30
...
#define SLEEP_WAKE_SRC_RTC_CMP3 {1, IRQ_ID_CMP3}
#define SLEEP_WAKE_SRC_KEY      {1, IRQ_ID_KEY}
/* PMU sleep wake up source list */
#define CONFIG_SLEEP_WAKE_SRC_LIST  {SLEEP_WAKE_SRC_LPCMP, SLEEP_WAKE_SRC_BT1, SLEEP_WAKE_SRC_BT, SLEEP_WAKE_SRC_GPIO, SLEEP_WAKE_SRC_RTC_CMP0, SLEEP_WAKE_SRC_RTC_CMP3, SLEEP_WAKE_SRC_KEY}
...
#define CONFIG_BT_RX_STACK_SIZE 1280
